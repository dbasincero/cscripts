...
PRO HOST_NAME    : &&cs_host_name. CPU_UTIL:&&cs_cpu_util_perc. LOAD:&&cs_cpu_load. CORES:&&cs_num_cpu_cores. THREADS:&&cs_num_cpus. &&cs_host_shape. &&cs_disk_config. BOOT:&&cs_system_boot_time. USER:&&who_am_i.
...
PRO PHONE_BOOK   : &&cs_phonebook_pdb. COMPARTMENT_ID:&&cs_compartment_id_pdb.
PRO APPLICATION  : &&cs_kiev_version. SCHEMA:&&cs_schema_name. 
PRO KIEV_STORE   : &&cs_kiev_store_name.
