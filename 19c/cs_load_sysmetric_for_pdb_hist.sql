--==========================================================================
-- Script    : cs_load_sysmetric_for_pdb_hist.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Carga do Sistema conforme View DBA_HIST_CON_SYSMETRIC_SUMM
--             para um PDB (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   cs_load_sysmetric_for_pdb_hist.sql
--
-- Purpose:     System Load as per DBA_HIST_CON_SYSMETRIC_SUMM View for a PDB (text report)
--
...
--              SQL> @cs_load_sysmetric_for_pdb_hist.sql
--
...
DEF script_name = 'cs_load_sysmetric_for_pdb_hist';
--
