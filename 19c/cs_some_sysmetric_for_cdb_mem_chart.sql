--==========================================================================
-- Script    : cs_some_sysmetric_for_cdb_mem_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Algumas Métricas de Sistema conforme View V$SYSMETRIC_HISTORY
--             para um CDB (gráfico de série temporal)
-- Variaveis  : posicionais &1, &2, &3, &4, &5, &6, &7, &8
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   cs_some_sysmetric_for_cdb_mem_chart.sql
--
-- Purpose:     Some System Metrics as per V$SYSMETRIC_HISTORY View for a CDB (time series chart)
--
...
--              SQL> @cs_some_sysmetric_for_cdb_mem_chart.sql
--
...
--
DEF report_title = "CDB System Metrics (value)";
DEF chart_title = "CDB System Metrics (value)";
DEF xaxis_title = "";
