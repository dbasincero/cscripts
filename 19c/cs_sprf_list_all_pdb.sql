--==========================================================================
-- Script    : cs_sprf_list_all_pdb.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Lista todos os SQL Profiles para alguma string de SQL Text no
--             PDB
...
----------------------------------------------------------------------------------------
--
-- File name:   cs_sprf_list_all_pdb.sql
--
-- Purpose:     List all SQL Profiles for some SQL Text string on PDB
--
...
--
DEF cs_script_name = 'cs_sprf_list_all_pdb';
--
