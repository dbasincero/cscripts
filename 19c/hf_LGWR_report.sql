--==========================================================================
-- Script    : hf_LGWR_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Relatório de Duração de Escritas Lentas do Log Writer LGWR -
--             a partir do trace atual do LGWR
-- Variaveis  : &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_LGWR_report.sql
--
