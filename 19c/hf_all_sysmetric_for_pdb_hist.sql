--==========================================================================
-- Script    : hf_all_sysmetric_for_pdb_hist.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Todas as Métricas de Sistema conforme View
--             DBA_HIST_CON_SYSMETRIC_SUMM para um PDB (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_all_sysmetric_for_pdb_hist.sql
--
...
--              SQL> @hf_all_sysmetric_for_pdb_hist.sql
--
