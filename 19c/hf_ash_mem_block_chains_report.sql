--==========================================================================
-- Script    : hf_ash_mem_block_chains_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Relatório de Cadeias de Bloqueio do ASH a partir da MEM
-- Variaveis  : posicionais &3; &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_ash_mem_block_chains_report.sql
--
...
--              SQL> @hf_ash_mem_block_chains_report.sql
--
