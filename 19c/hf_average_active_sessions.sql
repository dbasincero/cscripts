--==========================================================================
-- Script    : hf_average_active_sessions.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Average Active Sessions (ASH Analytics sobre
--             dbc_active_session)
-- Atalhos    : aas.sql
...
----------------------------------------------------------------------------------------
--
-- File name:   aas.sql | hf_average_active_sessions.sql 
--
...
--              SQL> @hf_average_active_sessions.sql
--
...
UNDEF 10;
--
DEF spool_id_chart_footer_script = 'hf_ash_analytics_footer.sql';
COL rn FOR 999;
