--==========================================================================
-- Script    : hf_blocked_sessions_ash_awr_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Top Bloqueadores de Sessão por múltiplas Dimensões conforme
--             ASH a partir do AWR (relatório em texto)
-- Variaveis  : &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_blocked_sessions_ash_awr_report.sql
--
...
--              SQL> @hf_blocked_sessions_ash_awr_report.sql
--
