--==========================================================================
-- Script    : hf_blocked_sessions_by_machine_ash_awr_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Top Bloqueadores de Sessão por Máquina do Bloqueador Raiz
--             conforme ASH a partir do AWR (gráfico de série temporal)
-- Variaveis  : posicionais &3; &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_blocked_sessions_by_machine_ash_awr_chart.sql
--
...
--              SQL> @hf_blocked_sessions_by_machine_ash_awr_chart.sql
--
