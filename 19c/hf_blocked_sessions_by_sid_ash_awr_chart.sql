--==========================================================================
-- Script    : hf_blocked_sessions_by_sid_ash_awr_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Top Bloqueadores de Sessão por SID do Bloqueador Raiz
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_blocked_sessions_by_sid_ash_awr_chart.sql
--
...
--              SQL> @hf_blocked_sessions_by_sid_ash_awr_chart.sql
--
