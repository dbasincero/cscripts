--==========================================================================
-- Script    : hf_blocked_sessions_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Relatório de Sessões Bloqueadas
-- Atalhos    : bs.sql
...
----------------------------------------------------------------------------------------
--
-- File name:   bs.sql | hf_blocked_sessions_report.sql
--
...
--              SQL> @hf_blocked_sessions_report.sql
--
