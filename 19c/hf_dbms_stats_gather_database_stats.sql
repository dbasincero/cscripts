--==========================================================================
-- Script    : hf_dbms_stats_gather_database_stats.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Executa DBMS_STATS.GATHER_DATABASE_STATS
-- Seguranca  : gera arquivo via SPOOL
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_dbms_stats_gather_database_stats.sql
--
...
--              SQL> @hf_dbms_stats_gather_database_stats.sql
--
