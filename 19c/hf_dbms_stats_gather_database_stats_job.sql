--==========================================================================
-- Script    : hf_dbms_stats_gather_database_stats_job.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Executa DBMS_STATS.GATHER_DATABASE_STATS (stand-alone)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_dbms_stats_gather_database_stats_job.sql
--
...
--              SQL> @hf_dbms_stats_gather_database_stats_job.sql
--
