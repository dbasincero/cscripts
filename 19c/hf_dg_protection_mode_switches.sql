--==========================================================================
-- Script    : hf_dg_protection_mode_switches.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Mudanças de Protection Mode do Data Guard conforme Log
--             Archive Dest
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_dg_protection_mode_switches.sql
--
...
--              SQL> @hf_dg_protection_mode_switches.sql
--
