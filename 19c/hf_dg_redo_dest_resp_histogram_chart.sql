--==========================================================================
-- Script    : hf_dg_redo_dest_resp_histogram_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Gráfico de Duração de Transporte de REDO do Data Guard (DG)
-- Variaveis  : posicionais &3, &4; &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_dg_redo_dest_resp_histogram_chart.sql
--
...
--              SQL> @hf_dg_redo_dest_resp_histogram_chart.sql
--
