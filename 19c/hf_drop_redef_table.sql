--==========================================================================
-- Script    : hf_drop_redef_table.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Gera comandos para remover objetos obsoletos de
--             Redefinição(ões) de Tabela com falha
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_drop_redef_table.sql
--
