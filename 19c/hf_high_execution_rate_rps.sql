--==========================================================================
-- Script    : hf_high_execution_rate_rps.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Lista execuções por tempo para um dado SQL_ID com alto RPS
-- Variaveis  : posicionais &1, &2; &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_high_execution_rate_rps.sql
--
...
--              SQL> @hf_high_execution_rate_rps.sql
--
