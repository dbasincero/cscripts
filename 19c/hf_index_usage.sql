--==========================================================================
-- Script    : hf_index_usage.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Uso de Índice (um índice ainda está em uso?)
-- Variaveis  : posicionais &1, &2, &3; &&cs_dbid
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_index_usage.sql
--
