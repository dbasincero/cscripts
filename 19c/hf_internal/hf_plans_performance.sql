--==========================================================================
-- Script    : hf_plans_performance.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Script de diagnóstico/utilitário Oracle (ver corpo do script
--             para detalhes).
-- Variaveis  : &&cs_dbid, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
-- hf_plans_performance.sql: called by multiple cs_sprf*, cs_spch*, cs_spbl*, and by: hf_planx.sql, hf_sqlperf.sql and hf_purge_cursor.sql 
