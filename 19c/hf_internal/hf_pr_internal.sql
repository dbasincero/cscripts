...
--
-- Examples:    1. SQL> @hf_pr_internal.sql "/tmp/carlos.sql"
--
--              2. SQL> @hf_pr_internal.sql "SELECT * FROM v$database;"
--
--              3. SQL> @hf_pr_internal.sql ""
--
-- Notes:       When passing a query which contains single quotes then double them
--              e.g. SQL> @hf_pr_internal.sql "SELECT sid||'',''||serial# AS sid_serial FROM v$session"
--
