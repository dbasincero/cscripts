--==========================================================================
-- Script    : hf_kill_scheduler.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Encerra Sessões de Usuário aguardando no Scheduler (Resource
--             Manager)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_kill_scheduler.sql
--
-- Purpose:     Kill User Sessions waiting on Scheduler (Resource Manager)
--
