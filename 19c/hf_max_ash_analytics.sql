--==========================================================================
-- Script    : hf_max_ash_analytics.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Versão simplificada do ASH Analytics para todos os Eventos
--             Temporizados (Maximum Active Sessions)
-- Atalhos    : ma.sql
-- Variaveis  : posicionais &3, &4, &5, &6, &7, &8, &9, &10, &11; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   ma.sql | hf_max_ash_analytics.sql
--
