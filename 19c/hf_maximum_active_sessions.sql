--==========================================================================
-- Script    : hf_maximum_active_sessions.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Maximum Active Sessions (ASH Analytics sobre
--             dbc_active_session)
-- Atalhos    : mas.sql
-- Variaveis  : posicionais &3, &4, &5, &6, &7, &8, &9, &10; &&cs_con_name, &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   mas.sql | hf_maximum_active_sessions.sql 
--
...
--              SQL> @hf_maximum_active_sessions.sql
--
...
UNDEF 10;
--
DEF spool_id_chart_footer_script = 'hf_max_ash_analytics_footer.sql';
COL rn FOR 999;
