--==========================================================================
-- Script    : hf_one_sysmetric_per_pdb_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Uma Métrica de Sistema conforme View
--             DBA_HIST_CON_SYSMETRIC_SUMM por PDB (gráfico de série
--             temporal)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_one_sysmetric_per_pdb_chart.sql
--
...
--              SQL> @hf_one_sysmetric_per_pdb_chart.sql
--
