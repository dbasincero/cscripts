--==========================================================================
-- Script    : hf_redef_table.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Redefinição de Tabela
-- Variaveis  : posicionais &1, &2, &3, &4, &5, &6; &&cs_con_name
...
/
PRO
PRO 5. CLOB Compression and Deduplication: [{NO}|C|CD] NO:None, C:Compression, CD:Compression and Deduplication
DEF redeflob = '&5.';
UNDEF 5;
...
@@hf_internal/hf_lobs_internal.sql
--
