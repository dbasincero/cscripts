--==========================================================================
-- Script    : hf_redef_table_silent.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Redefinição de Tabela - Silenciosa
-- Variaveis  : posicionais &1, &2, &3; &&cs_con_name, &&cs_reference
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_redef_table_silent.sql
--
...
---------------------------------------------------------------------------------------
--
DEF cs_reference = 'hf_redef_table_silent.sql';
