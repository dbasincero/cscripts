--==========================================================================
-- Script    : hf_segment_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Tamanho em GBs de Segment para um dado Segment (gráfico de
--             série temporal)
-- Variaveis  : posicionais &3, &4, &5, &6, &7; &&cs_con_name, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_segment_chart.sql
--
