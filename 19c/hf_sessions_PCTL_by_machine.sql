--==========================================================================
-- Script    : hf_sessions_PCTL_by_machine.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Percentis de Sessões por Máquina
-- Variaveis  : &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sessions_PCTL_by_machine.sql
--
...
--              SQL> @hf_sessions_PCTL_by_machine.sql
--
