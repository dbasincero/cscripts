--==========================================================================
-- Script    : hf_sessions_by_type_and_status_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Sessões por Tipo e Status (gráfico de série temporal)
-- Variaveis  : posicionais &3; &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sessions_by_type_and_status_chart.sql
--
...
--              SQL> @hf_sessions_by_type_and_status_chart.sql
--
