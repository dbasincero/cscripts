--==========================================================================
-- Script    : hf_sgastat_awr_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Relatório de Histórico de Pools da SGA a partir do AWR
--             (inclui memória livre)
-- Variaveis  : &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sgastat_awr_report.sql
--
-- Purpose:     SGA Pools History Report from AWR (include free memory)
--
