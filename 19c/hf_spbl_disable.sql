--==========================================================================
-- Script    : hf_spbl_disable.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Desabilita um ou todos os SQL Plan Baselines para um dado
--             SQL_ID
...
BEGIN
  ...
  LOOP
    ...
    l_plans := DBMS_SPM.alter_sql_plan_baseline(sql_handle => i.sql_handle, plan_name => i.plan_name, attribute_name => 'DESCRIPTION', attribute_value => TRIM(i.description||' &&cs_script_name..sql &&cs_reference_sanitized. &&who_am_i. DISABLED='||TO_CHAR(SYSDATE, '&&cs_datetime_full_format.')));    
  END LOOP;
END;
/
--
