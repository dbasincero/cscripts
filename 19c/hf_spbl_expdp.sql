--==========================================================================
-- Script    : hf_spbl_expdp.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Empacota na tabela de staging um ou todos os SQL Plan
--             Baselines para um dado SQL_ID e Exporta tais Baselines usando
--             Datapump
-- Variaveis  : posicionais &1; &&cs_con_name, &&cs_signature, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_spbl_expdp.sql
--
...
PRO
PRO 2. SQL> @hf_spbl_impdp.sql "&&cs_dp_file_name..dmp" "&&cs_sql_id." "&&cs_plan_name."
