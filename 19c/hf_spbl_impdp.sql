--==========================================================================
-- Script    : hf_spbl_impdp.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Importa de arquivo Datapump para uma tabela de staging todos
--             os SQL Plan Baselines e Desempacota da tabela de staging um
--             ou todos os SQL Plan Baselines para um dado SQL
-- Variaveis  : posicionais &1, &2, &3; &&cs_signature, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_spbl_impdp.sql
--
