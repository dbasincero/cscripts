--==========================================================================
-- Script    : hf_spbl_sprf_spch_drop_all.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Remove todos os SQL Plan Baselines, SQL Profiles e SQL
--             Patches para alguma string de SQL Text no PDB
-- Variaveis  : posicionais &1, &2; &&cs_con_name
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_spbl_sprf_spch_drop_all.sql
--
...
--              SQL> @hf_spbl_sprf_spch_drop_all.sql
--
