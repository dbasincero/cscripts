--==========================================================================
-- Script    : hf_spch_list_all_cdb.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Lista todos os SQL Patches para alguma string de SQL Text no
--             CDB
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_spch_list_all_cdb.sql
--
-- Purpose:     List all SQL Patches for some SQL Text string on CDB
--
...
--
DEF cs_script_name = 'cs_spch_list_all_cdb';
--
...
--
PRO
PRO SQL PATCHES - LIST (cdb_sql_patches)
PRO ~~~~~~~~~~~~~~~~~~
WITH
...
SELECT /*+ MATERIALIZE NO_MERGE */
       con_id, sql_patch, COUNT(*) AS child_cursors
  FROM v$sql
