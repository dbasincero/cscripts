--==========================================================================
-- Script    : hf_spch_xfr.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Transfere um SQL Patch para um dado SQL_ID
...
--   '    description => ''hf_spch_xfr.sql /*+ ''||:hint_text||'' */ &&cs_reference_sanitized. &&who_am_i.'''||CHR(10)||
--   '  );'||CHR(10)||
--   'END;'||CHR(10)||
--   '/';
-- END;
...
BEGIN
  ...
  '      description => ''hf_spch_xfr.sql /*+ ''||l_hint_text||'' */ &&cs_reference_sanitized. &&who_am_i.'''||CHR(10)||
  '    ); --12c'||CHR(10)||
  '  $ELSE'||CHR(10)||
