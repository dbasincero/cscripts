--==========================================================================
-- Script    : hf_sprf_export.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Exporta Planos de Execução para algum SQL_ID ou todo SQL em
--             alguns PDBs, usando SQL Profile(s)
-- Variaveis  : posicionais &1, &2, &3; &&cs_con_name, &&cs_reference, &&cs_sql_id
-- Seguranca  : usa EXECUTE IMMEDIATE (SQL dinâmico); gera arquivo via SPOOL
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sprf_export.sql
--
