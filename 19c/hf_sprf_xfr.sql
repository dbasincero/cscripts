--==========================================================================
-- Script    : hf_sprf_xfr.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Transfere um SQL Profile para um dado SQL_ID
...
BEGIN
  ...
  '    description => ''hf_sprf_xfr.sql ''||:sql_id_from_xfr_1_to_xfr_2||'' &&cs_plan_hash_value. &&cs_reference_sanitized. &&who_am_i.'','||CHR(10)||
