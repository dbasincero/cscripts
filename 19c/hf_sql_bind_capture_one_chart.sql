--==========================================================================
-- Script    : hf_sql_bind_capture_one_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : SQL Bind Capture para um dado SQL_ID e nome de Bind (gráfico
--             de série temporal)
-- Variaveis  : posicionais &3, &4; &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sql_bind_capture_one_chart.sql
--
...
--              SQL> @hf_sql_bind_capture_one_chart.sql
--
