--==========================================================================
-- Script    : hf_sql_latency_histogram.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Histograma de Latência de SQL (tempo decorrido por execução)
-- Variaveis  : posicionais &3, &4, &5; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sql_latency_histogram.sql
--
...
--              SQL> @hf_sql_latency_histogram.sql
--
