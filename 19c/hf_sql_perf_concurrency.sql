--==========================================================================
-- Script    : hf_sql_perf_concurrency.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Histograma de Concorrência de SQL com mais de N Sessões
--             Concorrentes
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_sql_perf_concurrency.sql
--
-- Purpose:     Concurrency Histogram of SQL with more than N Concurrent Sessions
--
...
--              SQL> @hf_sql_perf_concurrency.sql
--
...
--
COL concurrency FOR 999,990 HEA 'Concurrent|Sessions';
