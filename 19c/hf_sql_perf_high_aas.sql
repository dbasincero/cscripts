--==========================================================================
-- Script    : hf_sql_perf_high_aas.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : SQL com AAS por hora para um dado Evento Temporizado maior
--             que N (relatório em texto de série temporal)
-- Variaveis  : posicionais &3, &4, &5, &6, &7; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sql_perf_high_aas.sql
--
