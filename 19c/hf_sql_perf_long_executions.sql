--==========================================================================
-- Script    : hf_sql_perf_long_executions.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Execuções de SQL com duração maior que N segundos
-- Variaveis  : posicionais &3, &4, &5, &6; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sql_perf_long_executions.sql
--
-- Purpose:     SQL Executions longer than N seconds
--
...
--              SQL> @hf_sql_perf_long_executions.sql
--
...
--
COL sql_exec_id FOR 999999999 HEA 'Execution ID';
COL sql_exec_start FOR A19 HEA 'SQL Execution Start';
COL f_sample_time FOR A26 HEA 'First Sample Time';
COL l_sample_time FOR A26 HEA 'Last Sample Time';
