--==========================================================================
-- Script    : hf_sqlmon_mem.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Relatório SQL Monitor para um dado SQL_ID (a partir da MEM)
-- Variaveis  : posicionais &1, &2, &3, &4, &5; &&cs_sql_id
-- Seguranca  : gera arquivo via SPOOL
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sqlmon_mem.sql
--
