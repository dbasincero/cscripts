--==========================================================================
-- Script    : hf_sqlstat_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Relatório de Estatísticas de SQL (AWR) - detalhado(15m), por
--             hora, diário, global
-- Atalhos    : ssr.sql
-- Variaveis  : posicionais &3, &4, &5, &6, &7, &8; &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   ssr.sql | hf_sqlstat_report.sql
--
...
--
@@hf_internal/cs_dba_hist_sqlstat_&&cs_report_type..sql
--
PRO
PRO SQL> @&&cs_script_name..sql "&&cs_sample_time_from." "&&cs_sample_time_to." "&&cs_report_type." "&&cs_include_uncommon_columns." "&&cs_include_delta_columns." "&&cs_include_sys." "&&cs2_sql_text_piece." "&&cs_sql_id."
--
