--==========================================================================
-- Script    : hf_sysstat_hist_chart_io.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Estatísticas de Sistema de I/O a partir do AWR (gráfico de
--             série temporal)
-- Variaveis  : posicionais &3, &4, &5; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sysstat_hist_chart_io.sql
--
...
--              SQL> @hf_sysstat_hist_chart_io.sql
--
