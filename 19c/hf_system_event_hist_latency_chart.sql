--==========================================================================
-- Script    : hf_system_event_hist_latency_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Subconjunto de Latência de System Event a partir do AWR
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_system_event_hist_latency_chart.sql
--
-- Purpose:     Subset of System Event Latency from AWR (time series chart)
--
...
--              SQL> @hf_system_event_hist_latency_chart.sql
--
...
--
DEF report_title = "System Event History - Latency (milliseconds)";
DEF chart_title = "System Event History - Latency (milliseconds)";
...
DEF vaxis_title = "Average Latency (milliseconds)";
--
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||num_format(q.latency_1, 3)|| 
       ','||num_format(q.latency_2, 3)|| 
       ','||num_format(q.latency_3, 3)|| 
       ','||num_format(q.latency_4, 3)|| 
       ','||num_format(q.latency_5, 3)|| 
       ','||num_format(q.latency_6, 3)|| 
       ']'
  FROM my_query q
 ORDER BY
       q.time
