--==========================================================================
-- Script    : hf_system_event_histogram_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Histograma de Carga AAS de um System Event a partir do AWR
--             conforme Bucket de Latência (gráfico de série temporal)
-- Variaveis  : posicionais &3; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_system_event_histogram_chart.sql
--
...
--              SQL> @hf_system_event_histogram_chart.sql
--
