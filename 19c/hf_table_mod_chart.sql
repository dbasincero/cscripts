--==========================================================================
-- Script    : hf_table_mod_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Histórico de Modificações da Tabela (INS, DEL e UPD) para uma
--             dada Tabela (gráfico de série temporal)
-- Variaveis  : posicionais &3, &4, &5; &&cs_con_name, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_table_mod_chart.sql
--
