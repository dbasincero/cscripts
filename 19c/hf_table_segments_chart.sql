--==========================================================================
-- Script    : hf_table_segments_chart.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Tamanho em GBs de Segments relacionados à Tabela (Table,
--             Indexes e Lobs) para uma dada Tabela (gráfico de série
--             temporal)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_table_segments_chart.sql 
--
...
--              SQL> @hf_table_segments_chart.sql
--
