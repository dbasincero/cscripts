--==========================================================================
-- Script    : hf_table_stats_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Histórico de Estatísticas do CBO para uma dada Tabela
--             (relatório em texto de série temporal)
-- Variaveis  : posicionais &3, &4; &&cs_con_name, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_table_stats_report.sql
--
