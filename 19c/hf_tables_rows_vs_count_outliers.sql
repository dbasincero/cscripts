--==========================================================================
-- Script    : hf_tables_rows_vs_count_outliers.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Compara linhas das Estatísticas do CBO com COUNT(*) nas
--             Tabelas de Aplicação e Reporta Outliers
-- Seguranca  : usa EXECUTE IMMEDIATE (SQL dinâmico)
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
SET TERM ON HEA ON LIN 2490 PAGES 100 TAB OFF FEED OFF ECHO OFF VER OFF TRIMS ON TRIM ON TI OFF TIMI OFF LONG 240000 LONGC 2400 NUM 20 SERVEROUT OFF;
-- hf_tables_rows_vs_count_outliers.sql - Compares CBO Stats Rows to COUNT(*) on Application Tables and Reports Outliers
SET SERVEROUT ON;
DECLARE
  l_cnt INTEGER;
  l_pct INTEGER;
