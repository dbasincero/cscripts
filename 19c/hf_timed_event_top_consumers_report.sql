--==========================================================================
-- Script    : hf_timed_event_top_consumers_report.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Principais contribuintes de uma dada Wait Class ou Event
--             (relatório em texto)
-- Variaveis  : posicionais &3, &4; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_timed_event_top_consumers_report.sql
--
-- Purpose:     Top contributors of a given Wait Class or Event (text report)
--
...
--              SQL> @hf_timed_event_top_consumers_report.sql
--
...
/
PRO
PRO 4. Dimension: [{PDB_NAME}|SQL_ID|TOP_LEVEL_SQL_ID|MACHINE|PROGRAM|MODULE|ACTION|SESSION_ID|USER_ID|WAIT_CLASS|EVENT|CURRENT_OBJ#]
...
PRO DIMENSION    : "&&gb_column_name." [{PDB_NAME}|SQL_ID|TOP_LEVEL_SQL_ID|MACHINE|PROGRAM|MODULE|ACTION|SESSION_ID|USER_ID|WAIT_CLASS|EVENT|CURRENT_OBJ#]
--
...
/****************************************************************************************/
PRO
PRO Top &&gb_column_name as per "&&timed_event." contribution between &&cs_sample_time_from. and &&cs_sample_time_to.
PRO ~~~
WITH
...
SELECT percent AS perc, value, NVL(slice_name, '"null"') AS slice_name
  FROM aggregated
 ORDER BY
       percent DESC
FETCH FIRST 30 ROWS ONLY
