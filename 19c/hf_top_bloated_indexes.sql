--==========================================================================
-- Script    : hf_top_bloated_indexes.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Top índices inchados em um PDB (relatório em texto)
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_top_bloated_indexes.sql
--
...
--              SQL> @hf_top_bloated_indexes.sql
--
