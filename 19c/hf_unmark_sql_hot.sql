--==========================================================================
-- Script    : hf_unmark_sql_hot.sql
-- Versao    : Oracle Database 19c (19.x)
-- Uso       : Usa DBMS_SHARED_POOL.unmarkhot para desfazer
--             hf_mark_sql_hot.sql
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_unmark_sql_hot.sql
--
-- Purpose:     Use DBMS_SHARED_POOL.unmarkhot to undo hf_mark_sql_hot.sql
--
