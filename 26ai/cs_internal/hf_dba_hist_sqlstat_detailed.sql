--==========================================================================
-- Script    : hf_dba_hist_sqlstat_detailed.sql
...
--==========================================================================
-- hf_dba_hist_sqlstat_detailed.sql: called by hf_sqlstat_report.sql, hf_planx.sql and hf_sqlperf.sql
@@hf_sqlstat_cols.sql
@@hf_sqlstat_compute.sql
PRO 
