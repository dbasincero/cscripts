...
SELECT open_mode, database_role, CASE WHEN open_mode = 'READ WRITE' AND database_role = 'PRIMARY' THEN 'hf_null.sql' ELSE 'hf_primary_warn.sql' END AS dynamic_script FROM v$database
/
@@&&dynamic_script.
