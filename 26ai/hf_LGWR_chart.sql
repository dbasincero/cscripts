--==========================================================================
-- Script    : hf_LGWR_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Gráfico de Duração de Escritas Lentas do Log Writer LGWR - a
--             partir do trace atual do LGWR
-- Variaveis  : &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_LGWR_chart.sql
--
