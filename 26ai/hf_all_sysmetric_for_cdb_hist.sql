--==========================================================================
-- Script    : hf_all_sysmetric_for_cdb_hist.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Todas as Métricas de Sistema conforme View
--             DBA_HIST_SYSMETRIC_SUMMARY para um CDB (relatório em texto)
-- Variaveis  : posicionais &1, &2, &3; &&cs_con_name
-- Seguranca  : gera arquivo via SPOOL
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_all_sysmetric_for_cdb_hist.sql
--
...
--              SQL> @hf_all_sysmetric_for_cdb_hist.sql
--
