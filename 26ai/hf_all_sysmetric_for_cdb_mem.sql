--==========================================================================
-- Script    : hf_all_sysmetric_for_cdb_mem.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Todas as Métricas de Sistema conforme Views V$SYSMETRIC para
--             um CDB (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_all_sysmetric_for_cdb_mem.sql
--
...
--              SQL> @hf_all_sysmetric_for_cdb_mem.sql
--
