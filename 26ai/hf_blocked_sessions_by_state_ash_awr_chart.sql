--==========================================================================
-- Script    : hf_blocked_sessions_by_state_ash_awr_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Top Bloqueadores de Sessão por State do Bloqueador Raiz
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_blocked_sessions_by_state_ash_awr_chart.sql
--
...
--              SQL> @hf_blocked_sessions_by_state_ash_awr_chart.sql
--
