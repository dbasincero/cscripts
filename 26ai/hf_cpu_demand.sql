--==========================================================================
-- Script    : hf_cpu_demand.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Versão simplificada do ASH Analytics para Demanda de CPU (ON
--             CPU + Scheduler)
-- Atalhos    : cpu.sql
-- Variaveis  : posicionais &3, &4, &5, &6, &7; &&cs_con_name, &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   cpu.sql | hf_cpu_demand.sql
--
