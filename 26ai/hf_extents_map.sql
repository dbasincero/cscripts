--==========================================================================
-- Script    : hf_extents_map.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Mapa de Blocos de Tablespace
-- Variaveis  : posicionais &1, &2, &3, &4; &&cs_con_name, &&cs_reference
-- Seguranca  : gera arquivo via SPOOL
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_extents_map.sql
--
...
--              SQL> @hf_extents_map.sql "KIEV" "PARTITION" "Y" "BOTTOM"
--              SQL> @hf_extents_map.sql "KIEV" "P" "Y" "B"
--              SQL> @hf_extents_map.sql KIEV S N T
--
