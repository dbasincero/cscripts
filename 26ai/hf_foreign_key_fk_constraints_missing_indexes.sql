--==========================================================================
-- Script    : hf_foreign_key_fk_constraints_missing_indexes.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Gera DDL para criar Índices ausentes que suportam constraints
--             de FK
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_foreign_key_fk_constraints_missing_indexes.sql
--
...
--              SQL> @hf_foreign_key_fk_constraints_missing_indexes.sql
--
