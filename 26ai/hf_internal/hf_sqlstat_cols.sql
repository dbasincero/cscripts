--==========================================================================
-- Script    : hf_sqlstat_cols.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Script auxiliar interno, invocado por outros scripts via @@
--             (não chamado diretamente).
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
-- hf_sqlstat_cols.sql: called by cs_dba_hist_sqlstat_*.sql, hf_gv_sqlstat_global.sql.sql, hf_gv_sql_global.sql, hf_gv_sql_stability.sql, hf_iod_sqlstats_detailed.sql, hf_fs_internal_query_1.sql
