--==========================================================================
-- Script    : hf_top_internal_foot.sql
...
PRO 3. For database load on last 1 minute use t.sql (hf_top.sql). Use ta.sql to eliminate report heading.
PRO 4. For database load over a time range use tr.sql (hf_top_range.sql).
PRO