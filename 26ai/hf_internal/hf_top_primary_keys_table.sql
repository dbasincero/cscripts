--==========================================================================
-- Script    : hf_top_primary_keys_table.sql
...
--
SELECT 'PRO'||CHR(10)||
       'PRO TOP_PRIMARY_KEYS when table has less than &&cs_num_rows_limit_display. rows (using approximate counts after 10M rows)'||CHR(10)||
       'PRO ~~~~~~~~~~~~~~~~'
FROM DUAL WHERE '&&cs_kiev_version.' <> 'NOT_KIEV' AND '&&table_name.' NOT LIKE 'KIEV%' -- this script ONLY executes on KIEV databases and excludes KIEV internal tables
/
--
SELECT /* hf_top_primary_keys_table.sql kiev */
       'PRO'||CHR(10)||
