--==========================================================================
-- Script    : hf_load_sysmetric_for_cdb_hist.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Carga do Sistema conforme View DBA_HIST_SYSMETRIC_SUMMARY
--             para um CDB (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_load_sysmetric_for_cdb_hist.sql
--
...
--              SQL> @hf_load_sysmetric_for_cdb_hist.sql
--
