--==========================================================================
-- Script    : hf_load_sysmetric_for_cdb_mem.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Carga do Sistema conforme Views V$SYSMETRIC para um CDB
--             (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_load_sysmetric_for_cdb_mem.sql
--
-- Purpose:     System Load as per V$SYSMETRIC Views for a CDB (text report)
--
...
--              SQL> @hf_load_sysmetric_for_cdb_mem.sql
--
...
DEF script_name = 'cs_load_sysmetric_for_cdb_mem';
--
