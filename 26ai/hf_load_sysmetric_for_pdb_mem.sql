--==========================================================================
-- Script    : hf_load_sysmetric_for_pdb_mem.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Carga do Sistema conforme Views V$CON_SYSMETRIC para um PDB
--             (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_load_sysmetric_for_pdb_mem.sql
--
...
--              SQL> @hf_load_sysmetric_for_pdb_mem.sql
--
