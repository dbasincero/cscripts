--==========================================================================
-- Script    : hf_load_sysmetric_per_pdb_hist.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Carga do Sistema conforme View DBA_HIST_CON_SYSMETRIC_SUMM
--             por PDB (relatório em texto)
-- Variaveis  : posicionais &1, &2, &3, &4; &&cs_con_name
-- Seguranca  : gera arquivo via SPOOL
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_load_sysmetric_per_pdb_hist.sql
--
...
--              SQL> @hf_load_sysmetric_per_pdb_hist.sql
--
