--==========================================================================
-- Script    : hf_load_sysmetric_per_pdb_mem.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Carga do Sistema conforme Views V$CON_SYSMETRIC por PDB
--             (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_load_sysmetric_per_pdb_mem.sql
--
...
--              SQL> @hf_load_sysmetric_per_pdb_mem.sql
--
