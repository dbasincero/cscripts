--==========================================================================
-- Script    : hf_locks_mon.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Resumo e Detalhes de Locks - Monitor
...
BEGIN
  ...
  LOOP
    DBMS_OUTPUT.put_line(q'[@@cs_internal/hf_locks_mon_internal.sql]');
