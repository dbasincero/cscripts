--==========================================================================
-- Script    : hf_osstat_cpu_load_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Carga dos Núcleos de CPU conforme Estatísticas do OS a partir
--             do AWR (gráfico de série temporal)
-- Variaveis  : &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_osstat_cpu_load_chart.sql
--
-- Purpose:     CPU Cores Load as per OS Stats from AWR (time series chart)
--
...
--              SQL> @hf_osstat_cpu_load_chart.sql
--
