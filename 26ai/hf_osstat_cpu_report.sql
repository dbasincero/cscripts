--==========================================================================
-- Script    : hf_osstat_cpu_report.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Carga e Ocupação dos Núcleos de CPU conforme Estatísticas do
--             OS a partir do AWR (relatório de série temporal)
-- Variaveis  : &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_osstat_cpu_report.sql
--
