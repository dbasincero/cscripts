--==========================================================================
-- Script    : hf_osstat_cpu_util_perc_now.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Percentual de Utilização de CPU - Agora
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_osstat_cpu_util_perc_now.sql
--
...
--              SQL> @hf_osstat_cpu_util_perc_now.sql
--
