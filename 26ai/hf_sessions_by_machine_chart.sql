--==========================================================================
-- Script    : hf_sessions_by_machine_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Sessões por Máquina (gráfico de série temporal)
-- Variaveis  : posicionais &3, &4, &5; &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sessions_by_machine_chart.sql
--
...
--              SQL> @hf_sessions_by_machine_chart.sql
--
