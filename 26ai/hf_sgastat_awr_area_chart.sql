--==========================================================================
-- Script    : hf_sgastat_awr_area_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Gráfico de Histórico de Pools da SGA a partir do AWR
-- Variaveis  : &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sgastat_awr_area_chart.sql
--
...
--              SQL> @hf_sgastat_awr_area_chart.sql
--
...
--
PRO ,{label:'Buffer Cache'    , id:'1', type:'number'}     
PRO ,{label:'Shared Pool'     , id:'2', type:'number'}      
PRO ,{label:'Large Pool'      , id:'3', type:'number'}     
PRO ,{label:'Java Pool'       , id:'4', type:'number'}     
PRO ,{label:'Streams Pool'    , id:'5', type:'number'}     
PRO ,{label:'Shared IO Pool'  , id:'6', type:'number'}    
PRO ]
--
SET HEA OFF PAGES 0;
/****************************************************************************************/
