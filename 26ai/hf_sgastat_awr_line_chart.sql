--==========================================================================
-- Script    : hf_sgastat_awr_line_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Gráfico de Histórico de Pools da SGA a partir do AWR (inclui
--             memória livre)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_sgastat_awr_line_chart.sql
--
...
--              SQL> @hf_sgastat_awr_line_chart.sql
--
