--==========================================================================
-- Script    : hf_some_sysmetric_for_pdb_mem_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Algumas Métricas de Sistema conforme View
--             V$CON_SYSMETRIC_HISTORY para um PDB (gráfico de série
--             temporal)
-- Variaveis  : posicionais &1, &2, &3, &4, &5, &6, &7, &8; &&cs_con_name
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_some_sysmetric_for_pdb_mem_chart.sql
--
...
--              SQL> @hf_some_sysmetric_for_pdb_mem_chart.sql
--
