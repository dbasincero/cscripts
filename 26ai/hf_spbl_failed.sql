--==========================================================================
-- Script    : hf_spbl_failed.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Lista de SQL Plans com: "Failed to use SQL plan baseline for
--             this statement"
...
PRO ~~~~~~~~~~~~~
SELECT  DISTINCT
        '@hf_spbl_drop.sql "'||p.sql_id||'" ""' AS line
FROM    v$sql_plan p,
        XMLTABLE('other_xml/info' PASSING XMLTYPE(p.other_xml) COLUMNS type VARCHAR2(30) PATH '@type', note VARCHAR2(4) PATH '@note', value VARCHAR2(30) PATH '.') x,
        v$sql s,
        dba_sql_plan_baselines b
