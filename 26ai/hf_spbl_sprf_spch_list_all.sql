--==========================================================================
-- Script    : hf_spbl_sprf_spch_list_all.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Lista todos os SQL Plan Baselines, SQL Profiles e SQL Patches
--             para alguma string de SQL Text no PDB
-- Variaveis  : posicionais &1
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_spbl_sprf_spch_list_all.sql
--
-- Purpose:     List all SQL Plan Baselines, SQL Profiles and SQL Patches for some SQL Text string on PDB
--
...
--              SQL> @hf_spbl_sprf_spch_list_all.sql
--
...
--
DEF cs_script_name = 'cs_spbl_sprf_spch_list_all';
--
...
used_profiles AS (
SELECT /*+ MATERIALIZE NO_MERGE */
       sql_profile, COUNT(*) AS child_cursors
  FROM v$sql
