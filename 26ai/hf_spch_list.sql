--==========================================================================
-- Script    : hf_spch_list.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Lista resumida de SQL Patches para um dado SQL_ID
-- Variaveis  : posicionais &1; &&cs_signature, &&cs_sql_handle, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_spch_list.sql
--
-- Purpose:     Summary list of SQL Patches for given SQL_ID
--
...
--
DEF cs_script_name = 'cs_spch_list';
--
PRO 1. SQL_ID: 
DEF cs_sql_id = '&1.';
UNDEF 1;
