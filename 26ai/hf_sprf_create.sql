--==========================================================================
-- Script    : hf_sprf_create.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Cria um SQL Profile para um dado SQL_ID
-- Variaveis  : posicionais &1, &2, &3; &&cs_dbid, &&cs_plan_hash_value, &&cs_signature, &&cs_sql_handle, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sprf_create.sql
--
...
BEGIN
  ...
  IF l_count = 0 THEN
    DBMS_SQLTUNE.import_sql_profile(
        ...
        description => 'hf_sprf_create.sql &&cs_sql_id. &&cs_plan_hash_value. &&cs_sql_id2. &&cs_reference_sanitized. &&who_am_i.',
        category    => 'DEFAULT',
        validate    => TRUE,
        replace     => TRUE
    );
