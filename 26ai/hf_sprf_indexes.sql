--==========================================================================
-- Script    : hf_sprf_indexes.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Lista de Índices Referenciados por todos os SQL Profiles no
--             PDB
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sprf_indexes.sql
--
-- Purpose:     List of Indexes Referenced by all SQL Profiles on PDB
--
...
--              SQL> @hf_sprf_indexes.sql
--
-- Notes:       Developed and tested on 19c.
--
--              ORA-00600: internal error code, arguments: [qkebCreateColInFro:1], [], [], [], [], [], [], [], [], [], [], [] -- see bug 31947732
--
---------------------------------------------------------------------------------------
--
...
--
DEF cs_script_name = 'cs_sprf_indexes';
--
...
SELECT /*+ MATERIALIZE NO_MERGE */
  ...
  FROM sys.sqlobj$data p,
       ...
       sys.sql$text t
 WHERE 1 = 1 -- p.signature = 16223414913647067245
   AND p.category = 'DEFAULT'
   AND p.obj_type = 1 /* 1:profile, 2:baseline, 3:patch */
