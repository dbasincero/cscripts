--==========================================================================
-- Script    : hf_sql_bind_capture_one.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : SQL Bind Capture para um dado SQL_ID e nome de Bind
--             (relatório em texto)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_sql_bind_capture_one.sql
--
...
--              SQL> @hf_sql_bind_capture_one.sql
--
