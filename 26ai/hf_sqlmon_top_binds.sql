--==========================================================================
-- Script    : hf_sqlmon_top_binds.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Top Binds do SQL Monitor para um dado SQL_ID
-- Variaveis  : posicionais &3; &&cs_sample_time_from, &&cs_sample_time_to, &&cs_signature, &&cs_sql_handle, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_sqlmon_top_binds.sql
--
