--==========================================================================
-- Script    : hf_sqlstat_analytics.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Analytics de Estatísticas de SQL (AWR) - Granularidade 15m
-- Atalhos    : ssa.sql
-- Variaveis  : posicionais &3, &4, &5, &6, &7, &8; &&cs_con_name, &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   ssa.sql | hf_sqlstat_analytics.sql
--
...
/
--
DEF spool_id_chart_footer_script = 'hf_sqlstat_analytics_footer.sql';
--
DEF sql_id_01 = '             ';
DEF sql_id_02 = '             ';
DEF sql_id_03 = '             ';
