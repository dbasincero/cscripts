--==========================================================================
-- Script    : hf_sqlstat_analytics_aggregate.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Analytics Agregado de Estatísticas de SQL (AWR) -
--             Granularidade 15m
-- Atalhos    : ssaa.sql
-- Variaveis  : posicionais &3, &4, &5, &6, &7, &8, &9; &&cs_con_name, &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   ssaa.sql | hf_sqlstat_analytics_aggregate.sql
--
...
--              SQL> @hf_sqlstat_analytics_aggregate.sql
--
