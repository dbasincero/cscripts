--==========================================================================
-- Script    : hf_top_pdb_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Top PDBs conforme uso de Núcleos de CPU, Espaço em Disco ou
--             Sessões (gráfico de série temporal)
-- Variaveis  : posicionais &3; &&cs_con_name, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_top_pdb_chart.sql
--
