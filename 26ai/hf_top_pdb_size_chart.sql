--==========================================================================
-- Script    : hf_top_pdb_size_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Top Utilização de Tamanho em Disco de PDB (gráfico de série
--             temporal)
...
----------------------------------------------------------------------------------------
--
-- File name:   hf_top_pdb_size_chart.sql
--
