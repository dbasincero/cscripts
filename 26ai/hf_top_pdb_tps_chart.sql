--==========================================================================
-- Script    : hf_top_pdb_tps_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Top PDBs conforme TPS (gráfico de série temporal)
-- Variaveis  : &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_top_pdb_tps_chart.sql
--
...
--
DEF spool_id_chart_footer_script = 'hf_top_14_footer.sql';
--
DEF top_01 = "";
DEF top_02 = "";
DEF top_03 = "";
