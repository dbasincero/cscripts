--==========================================================================
-- Script    : hf_total_and_parse_cpu_to_db_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Razão de CPU-para-DB Total e de Parse a partir do AWR
--             (gráfico de série temporal)
-- Variaveis  : posicionais &3, &4; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_total_and_parse_cpu_to_db_chart.sql
--
-- Purpose:     Total and Parse CPU-to-DB Ratio from AWR (time series chart)
--
...
--              SQL> @hf_total_and_parse_cpu_to_db_chart.sql
--
...
--
PRO ,{label:'Total CPU to Total DB Time', id:'1', type:'number'}        
PRO ,{label:'Parse CPU to Parse DB Time', id:'2', type:'number'}      
PRO ]
--
SET HEA OFF PAGES 0;
/****************************************************************************************/
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||num_format(100 * q.total_cpu_secs / NULLIF(q.total_db_secs, 0), 1)|| 
       ','||num_format(100 * GREATEST(q.parse_cpu_secs, 1e-9) / GREATEST(q.parse_db_secs, 1e-9), 1)|| 
       ']'
  FROM my_query q
