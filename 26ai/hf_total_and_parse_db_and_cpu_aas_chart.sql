--==========================================================================
-- Script    : hf_total_and_parse_db_and_cpu_aas_chart.sql
-- Versao    : Oracle Database 26ai (26.x)
-- Uso       : Average Active Sessions (AAS) de DB e CPU Total e de Parse a
--             partir do AWR (gráfico de série temporal)
-- Variaveis  : posicionais &3, &4; &&cs_dbid, &&cs_sample_time_from, &&cs_sample_time_to, &&cs_sql_id
-- Pre-req    : conexao com privilegio de DBA (acessa views V$/DBA_/CDB_).
--==========================================================================
----------------------------------------------------------------------------------------
--
-- File name:   hf_total_and_parse_db_and_cpu_aas_chart.sql
--
...
--              SQL> @hf_total_and_parse_db_and_cpu_aas_chart.sql
--
