--==========================================================================
-- Script    : cs_oratop.sql
-- Versao    : Oracle Database 19c e 26ai (compativel com ambas)
...
--==========================================================================
-- ---------------------------------------------------------------------------
-- cs_oratop.sql — Monitor "estilo oratop" (snapshot) em SQL puro e EDITAVEL.
--
...
--   no shell:  watch -n5 "sqlplus -s user/pwd @cs_oratop.sql")
--
